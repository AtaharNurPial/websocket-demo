...
def sendMessage(message, connectionIds):
    ...
    for connectionId in connectionIds:
        client.post_to_connection(Data=message, ConnectionId=connectionId)
        ...
        if items is not None:
            ...
            try:
                ...
                if connection_response["Items"] is not None:
                    ...
                    try:
                        sendMessage(
                            message=payload, connectionIds=receiverConnectionIds
                        )
                        return {
                            "statusCode": 200,
                            "body": json.dumps(
                ...
                return {
                    "statusCode": 400,
                    "body": json.dumps({"message": "User is not connected."}),
                }
        else:
            return {
                "statusCode": 400,
